...
export default async function ReservationsPage() {
  ...
  const [reservationsRes, dressesRes, clientsRes] = await Promise.all([
    supabase
      .from("reservations")
      .select(
        "id, contract_number, client_id, reservation_date, start_date, end_date, status, total_price, supplement, deposit_paid, balance_due, caution_amount, caution_status, notes, reservation_dresses(dress_id, price, base_price, discount_amount, dresses(reference,name)), clients(first_name,last_name,phone)"
      )
